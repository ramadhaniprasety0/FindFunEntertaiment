...
const ForgotPasswordForm = () => {
  ...
  return (
    <div className="forgot-password-form text-center px-4 w-100" style={{ maxWidth: '400px' }}>
      <Form onSubmit={handleSubmit}>
        <h2 className="fw-bold mb-4" style={{color: "#8e97fd"}}>Lupa Kata Sandi</h2>
      ...
      <hr />
      <p className="small">
        <Link to="/login" className="text-decoration-none" style={{color:"#8e97fd"}}>Kembali ke halaman login</Link>
      </p>
