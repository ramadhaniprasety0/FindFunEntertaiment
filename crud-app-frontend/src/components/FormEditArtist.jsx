...
const FormEditArtis = () => {
    ...
    useEffect(() => {
        const fetchArtistData = async () => {
            try {
                setLoading(true);
                const { data } = await axios.get(`http://localhost:3000/artist/getartist/${id}`);
    ...
    const handleUpdateData = async (e) => {
        ...
        try {
            ...
            if (activeYearStart) formData.append("active_year_start", activeYearStart);
                    ...
                    <form onSubmit={handleUpdateData}>
                        <div className="row mb-3">
                            <div className="col-md-6">
                                <div className="mb-3">
                                    <label htmlFor="name" className="form-label">Nama Artist <span className="text-danger">*</span></label>
                                    <input 
                                        type="text" 
                        ...
                        <div className="mb-3">
                            <label htmlFor="bio" className="form-label">Biografi</label>
                            <textarea 
                                id="bio" 
                                className="form-control" 
                                value={bio} 
                        ...
                        <div className="row mb-3">
                            <div className="col-md-6">
                                <div className="mb-3">
                                    <label htmlFor="country" className="form-label">Negara Asal</label>
                                    <input 
                                        type="text" 
                                        className="form-control" 
                                        id="country" 
                        ...
                        <div className="row mb-3">
                            <div className="col-md-6">
                                <div className="mb-3">
                                    <label htmlFor="activeYearStart" className="form-label">Aktif Dari Tahun</label>
                                    <input 
                                        type="number" 
                                        className="form-control" 
                                        id="activeYearStart" 
                            ...
                            <div className="col-md-6">
                                <div className="mb-3">
                                    <label htmlFor="activeYearEnd" className="form-label">Aktif Sampai Tahun</label>
                                    <input 
                                        type="number" 
                                        className="form-control" 
                                        id="activeYearEnd" 
                        ...
                        <div className="row mb-3">
                            <div className="col-md-6">
                            <label htmlFor="image" className="form-label">Foto Artist</label>
                            <input
                                type="file"
                                className="form-control"
                                id="image"
                            ...
                            <div className="col-md-6">
                                <div className="mb-3">
                                    <label htmlFor="popularity" className="form-label">Popularitas (0-100)</label>
                                    <input 
                                        type="number" 
                                        className="form-control" 
                                        id="popularity" 
