...
const FormAddMusic = () => {
  ...
  const handleAddData = async (e) => {
    ...
    const exitingMusic = dataMusic.find(
      (music) => music.title.toLowerCase() === title.toLowerCase()
    );
    if (exitingMusic) {
      return Swal.fire(
        "Gagal!",
        "Music dengan judul ini sudah terdaftar",
        "error"
      );
    }
      ...
      <div className="card border-0 shadow-sm">
        ...
        <div className="card-body">
          <form onSubmit={handleAddData}>
              ...
              <div className="col-md-4">
                <div className="mb-3">
                  <label htmlFor="title" className="form-label">
                    Judul Music <span className="text-danger">*</span>
                  </label>
                  <input
                    type="text"
                    ...
                    required
                    placeholder="Masukkan judul music"
                  />
                </div>
              </div>
              <div className="col-md-4">
                <div className="mb-3">
                  <label htmlFor="release_year" className="form-label">
                    Tahun Rilis <span className="text-danger">*</span>
                  </label>
                  <input
                    type="text"
                    className="form-control"
            ...
            <div className="mb-3">
              <label htmlFor="lirik" className="form-label">
                Lirik Music <span className="text-danger">*</span>
              </label>
              <textarea
                id="lirik"
                className="form-control"
                ...
                required
                placeholder="Masukkan lirik music"
              ></textarea>
            </div>
            <div className="row mb-3 ">
            ...
            <div className="row mb-3">
              ...
              {album.map((albumItem, index) => (
                <div className="col-md-4" key={index}>
                  <label htmlFor={`album${index + 1}`} className="form-label">
                    Album {index + 1}
                  </label>
                  <div className="mb-3 d-flex flex-row">
                    <select
            ...
            <div className="row mb-3">
              <div className="col-md-3">
                <label htmlFor="spotify" className="form-label">
                  {" "}
                  Link Spotify <span className="text-warning">*</span>
                </label>
                <input
                  type="string"
                  id="spotify"
                  ...
                  placeholder="Masukkan link musik"
                />
              </div>
              <div className="col-md-3">
                <label htmlFor="apple" className="form-label">
                  {" "}
                  Link Apple Music <span className="text-warning">*</span>
                </label>
                <input
                  type="string"
                  id="apple"
              ...
              <div className="col-md-3">
                <label htmlFor="deezer" className="form-label">
                  {" "}
                  Link Deezer <span className="text-warning">*</span>
                </label>
                <input
                  type="string"
                  id="deezer"
              ...
              <div className="col-md-3">
                <label htmlFor="ytmusic" className="form-label">
                  {" "}
                  Link Yt Music <span className="text-warning">*</span>
                </label>
                <input
                  type="string"
                  id="ytmusic"
